...
In this blog post we're looking generating Open Graph preview images and how
...
compiled completely statically, I also have to provide a `getStaticPaths()`
function, which tells Astro all the different variants of this page that can
exist.
...
const POSTS_PATH = "./src/pages/blog"; // blog post directory
